...
class DingTalkService
{
    ...
    public function send()
    {
        ...
        try {
            ...
            $format = ApplicationContext::getContainer()->get(FormatterInterface::class)->format($e);
            ApplicationContext::getContainer()->get(StdoutLoggerInterface::class)->error($format);
